...
public enum StatusCode {
    ...
    NOT_MODIFIED(304), USE_PROXY(305), SWITCH_PROXY(306), TEMPORARY_REDIRECT(307),
    ...
    UNSUPPORTED_MEDIA_TYPE(415), RANGE_NOT_SATISFIABLE(416), EXPECTATION_FAILED(417),
    IM_A_TEAPOT(418), MISDIRECTED_REQUEST(421), UNPROCESSABLE_CONTENT(422), LOCKED(423),
